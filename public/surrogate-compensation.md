...
- Bed rest or household support when medically ordered and approved.
- Breast milk or pumping compensation when applicable.
- Lost wages or other approved reimbursements when applicable.

## Payment Protection

Surrogate compensation is described with escrow or trust account coordination so payments can follow agreed milestones and documentation.

Yunda coordinates around escrow planning but does not directly provide escrow services.

## Eligibility Caveat

Submitting an application is not a commitment. Final eligibility depends on:

- OB records.
- Medical screening and clinic clearance.
