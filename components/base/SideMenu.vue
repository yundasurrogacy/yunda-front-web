        ...
        <Transition name="menu-slide">
          ...
          >
            ...
            <div class="px-7 py-6 pt-16 md:hidden">
              ...
              <div class="mb-8">
                <h3
                  class="mb-3 border-b border-[var(--dark-brown)] pb-2 text-base text-[#271F18] font-normal"
                >
              ...
              <!-- 其他菜单项 -->
              <div
                class="mb-8 border-b border-t border-[var(--dark-brown)] pb-2 pt-2 space-y-3"
              >
            ...
            <div class="hidden px-8 py-6 pt-16 md:block">
              ...
              <!-- 其他菜单项 - 单列布局 -->
              <div
                class="mb-8 border-b border-t border-[var(--dark-brown)] pb-4 pt-4 space-y-3"
              >
                <!-- <a href="#" class="block text-[#271F18] text-sm font-normal hover:opacity-75 transition-opacity">
                  {{ $t('menu.logIn') }}
                </a> -->
