...
const defaultCards: BlogItem[] = [
  {
    ...
    category: '代孕流程相关',
    cover_img_url: '/images/home/surrogate-10.jpeg',
  },
  {
    title: '代孕妈妈筛选：我们看重什么',
    ...
    category: '代孕妈妈相关',
    cover_img_url: '/images/home/surrogate-11.webp',
  },
  {
    title: '费用结构与预算规划建议',
    ...
    category: '行业动态相关',
    cover_img_url: '/images/home/surrogate-12.webp',
  },
  {
    ...
    category: '法律法规相关',
    cover_img_url: '/images/home/surrogate-13.webp',
  },
]
        ...
        >
          <NuxtLink :to="getDetailPath(post)" class="block h-full">
            <div class="h-58 overflow-hidden">
              <img
                :src="post.cover_img_url || '/images/home/surrogate-2.jpeg'"
