...
<template>
  <section class="bg-[var(--olive-green)] px-4 py-20 md:px-20 md:py-25">
    <div class="z-10 mx-auto max-w-320 text-center">
      <h2 class="scroll-animate mb-12 text-center text-7.5 font-semibold md:mb-16 md:text-10" >
