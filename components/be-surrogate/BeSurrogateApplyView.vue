...
<template>
  <div class="min-h-screen bg-[var(--head-bg)]">
    ...
    >
      ...
      <div
        v-if="currentStep === 1"
        class="pointer-events-none absolute inset-0 min-h-[calc(100dvh-5rem)] md:min-h-[calc(100dvh-6.25rem)]"
        aria-hidden="true"
      >
        <img
      ...
      <div
        class="relative z-10 mx-auto max-w-320 px-3 md:px-6"
        :class="currentStep === 1
          ? 'flex min-h-[calc(100dvh-5rem)] md:min-h-[calc(100dvh-6.25rem)] flex-col pb-3 pt-3 md:pt-5'
          : 'py-8'"
      >
        <div
          class="min-h-0 flex flex-1 flex-col gap-4 lg:flex-row lg:items-stretch lg:gap-6"
        >
          <div
            v-if="currentStep === 1"
            class="flex shrink-0 flex-col justify-center text-center lg:max-w-2xl lg:w-[40%] space-y-3 lg:pr-2 lg:text-left lg:space-y-4"
          ...
          >
            ...
            <p class="text-4.5 text-white font-bold md:text-6 sm:text-5">
          ...
          <div
            id="gc-application"
            class="scroll-mt-28 border border-white/20 rounded-5 bg-white/95 shadow-[0_28px_64px_rgba(0,0,0,0.2)] backdrop-blur-md"
            :class="currentStep === 1
              ? 'order-3 flex min-h-0 w-full max-h-[calc(100dvh-13rem)] flex-col overflow-y-auto overflow-x-hidden lg:order-none lg:mb-0 lg:ml-auto lg:w-[58%] lg:max-h-[calc(100dvh-10rem)] lg:max-w-none p-3 sm:p-4 md:max-h-[calc(100dvh-12rem)]'
              : 'order-3 mb-6 p-6 sm:p-8 lg:mb-16 lg:p-10'"
          >
            <div
            ...
            >
              ...
              <div class="max-w-80 flex flex-1 gap-1.5 sm:gap-2">
                <span
            ...
            >
              ...
              <div class="grid grid-cols-1 gap-2.5 lg:grid-cols-2 sm:gap-3 lg:gap-x-10 lg:gap-y-2">
                ...
                <div data-field="occupation_type">
                  <p class="mb-1 text-3.5 leading-snug sm:mb-1.5 sm:text-4">
                  ...
                  <FormInput v-if="form.general_info.occupation_type === 'employed' || form.general_info.occupation_type === 'unemployed'" v-model="form.general_info.occupation_specify" class="mt-2" required />
                </div>
                <div data-field="marital_status">
                  ...
                  <FormInput v-if="form.general_info.marital_status === 'single'" v-model="form.general_info.single_partner_info" :label="t.gcIntake.singlePartnerInfo" class="mt-2" data-field="single_partner_info" />
                </div>
                ...
                <div data-field="ethnicity" class="lg:col-span-2">
                  ...
                  <div class="flex flex-wrap gap-2 sm:gap-x-3 sm:gap-y-2">
                  ...
                  <FormInput v-if="form.general_info.ethnicity.other" v-model="form.general_info.ethnicity.otherText" :label="t.gcIntake.ethnicitySelfDescribe" class="mt-2" data-field="ethnicity_other" />
                </div>
              </div>
            </div>
            ...
            <div
              ...
              :class="currentStep === 1 ? 'mt-3 shrink-0 sm:mt-4' : 'mt-12'"
            >
              <button
                v-if="currentStep > 1"
                type="button"
...
<style scoped>
/* 首屏 Step 1：压缩表单项垂直占位，便于在常见笔记本视口内一屏展示 */
.gc-step1-density :deep(label.mb-4),
.gc-step1-density :deep(label.mb-2\.5) {
...
.gc-step1-density :deep(input.h-15),
.gc-step1-density :deep(select.h-15),
.gc-step1-density :deep(button.h-15),
.gc-step1-density :deep(.h-15.flex-1) {
...
.gc-step1-density :deep(.mb-4.block) {
  margin-bottom: 0.25rem !important;
}
.gc-step1-density :deep(p.text-sage-500.mt-1\.5) {
