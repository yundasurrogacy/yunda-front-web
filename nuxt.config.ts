  ...
  app: {
    head: {
      ...
      meta: [
        ...
        { name: 'google-site-verification', content: 'dYqOv8c2hG5P6e-mn45QyFfv1eEahxARgl2Glk2iscY' },
        ...
        // 避免 GTM/GA 的 ccm/collect 等请求挂起时导致地址栏持续转圈
        {
          innerHTML: `window.addEventListener('load', function() {
              function loadAnalytics() {
                ...
                // Google Ads only. GA4 is configured by GTM so it has a single owner.
                var gtagScript = document.createElement('script');
                gtagScript.async = true;
                gtagScript.src = 'https://www.googletagmanager.com/gtag/js?id=AW-17913743847';
